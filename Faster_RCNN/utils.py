...
def parse_annotation(annodir_path, imgdir_path, image_dir, img_size, num_image):
    '''
    ...
    for i in range(num_image):
        ...
        for object_ in root.findall('object'):
            ...
            xmin = float(object_.find('bndbox')[0].text)
            ymin = float(object_.find('bndbox')[1].text)
            xmax = float(object_.find('bndbox')[2].text)
            ymax = float(object_.find('bndbox')[3].text)
